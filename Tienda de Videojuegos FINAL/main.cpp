...
//Mi programa es de una tienda de videojuegos. La tienda tiene un invetario de Consolas y Videojuegos.
//En la tienda puede haber un empleado o un Cliente y cada uno puede hacer cosas diferentes en la tienda.
//El Cliente puede observar el inventario y comprar algo, lo cual reducira la cantidad de videojuegos que hay.
//Y el empleado puede interactuar directamente con el inventario, agregando juegos, etc.
